...
{	
	String[] str = {"Impressora","Cota Restante","Cota Mensal"};
	int[] lar = {158,156,156};
...
class TabelaCotas extends JTable
{
	...
	{	
		...
		for (Grouppquota us : Form.group.getGrouppquotas())
		{
			String[] s = {us.getPrinters().getPrintername(),us.getSoftlimit()+"",us.getHardlimit()+""};
